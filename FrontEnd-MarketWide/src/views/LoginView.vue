    ...
    <div class="mt-[-190px] flex items-center justify-center h-screen">
        ...
        <form class="min-w-fit flex-col border bg-white px-6 py-14 shadow-md rounded-[4px]" @submit.prevent="handleSubmit"
            ...
            <div class="mt-5 flex justify-between text-sm text-gray-600">
                ...
                <RouterLink :to="{ name: 'register' }">Crea una cuenta</RouterLink>
            </div>
            <div class="flex justify-center mt-5 text-sm">
                <p class="text-gray-400">O Inicia</p>
            </div>
            ...
            <div class="mt-5 flex text-center text-sm text-gray-400">
                <p>
                    Este sitio es protegido por reCAPTCHA y Google <br />
                    <a class="underline" href="">Privacidad y Politica</a> y <a class="underline" href="">Terminos de
